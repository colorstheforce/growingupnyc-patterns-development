...
class StaticColumn {
  constructor() {
	...
	console.log("Hi from Static Column");
		...
		const stickyContent = document.querySelectorAll(StaticColumn.selector);
...
assignStickyFeature(stickyContent) {
    ...
    forEach(stickyContent, function(stickyContentElem) {
      StaticColumn.calcWindowPos(stickyContentElem);
		console.log(StaticColumn.calcWindowPos(stickyContentElem));
      /**
 ...
 StaticColumn.calcWindowPos = function(stickyContentElem) {
	...
	if (elemTop > 0) {
		console.log(StaticColumn.notStickyClass);
		
		stickyContentElem.classList.add(StaticColumn.selector);
	} else {
